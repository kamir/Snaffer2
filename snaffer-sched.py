...
# Please Specify The Capture Start Time and End Time.

#
#  This version of Sniffer writes packet Metadata and packet data into an Avro file 
#
...
def main():
	...
	if len(sys.argv) < 4 or len(sys.argv) > 4:
		...
		logWrite('sudo python snaffer.py <Capture_Device_Name> <start_time> <end_time>')
		logWrite('Example: sudo python snaffer.py eth0 "2013-09-28 20:30:55" "2013-09-28 20:30:58"')
		return
	...
	OUTFILE_NAME = 'dump/packetdump_' + hostname + '_' + Capture_Device + '_' + str(Start_Time.strftime('%Y-%m-%d-%H-%M-%S'))
